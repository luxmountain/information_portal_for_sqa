 ...
 * Test Cases: TC174 → TC175
 * File under test: src/utils/crudFactory.js (router.get '/'))
 * ============================================================
 *   - TC174: Phân trang hợp lệ (page=1, limit=5)   (Chuẩn)
 *   - TC175: Page vượt tổng số trang                (Ngoại lệ / Boundary)
 * ============================================================
 */
