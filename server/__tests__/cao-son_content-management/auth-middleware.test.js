 ...
 * Test Cases: TC172 → TC173
 * Files under test: src/middleware/auth.js, src/middleware/adminGuard.js
 *                   + crudFactory protect() function
 * ============================================================
 *   - TC172: Truy cập admin endpoint không có token   (Ngoại lệ)
 *   - TC173: Truy cập admin endpoint với student token (Ngoại lệ)
 * ============================================================
 */
...
/* ============================================================
 * TC172 – Truy cập admin endpoint không có token
 ...
 * ============================================================ */
describe('TC172 – authMiddleware: không có token', () => {
...
/* ============================================================
 * TC173 – Truy cập admin endpoint với student token
 * Loại: Ngoại lệ | CheckDB: N | Rollback: N
 ...
 * ============================================================ */
describe('TC173 – adminGuard: student token bị từ chối', () => {
