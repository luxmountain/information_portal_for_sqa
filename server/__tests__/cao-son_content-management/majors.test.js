 ...
 * Test Cases: TC168 → TC171
 * File under test: src/routes/majors.js
 * ============================================================
 *   - TC168: Tạo ngành học hợp lệ            (Chuẩn,  CheckDB ✓, Rollback ✓)
 *   - TC169: Tạo ngành học thiếu name         (Ngoại lệ)
 *   - TC170: Thêm môn học vào ngành           (Chuẩn,  CheckDB ✓, Rollback ✓)
 *   - TC171: Thêm môn học thiếu code          (Ngoại lệ)
 * ============================================================
 */
...
/* ============================================================
 * TC171 – Thêm môn học thiếu code
 * Loại: Ngoại lệ | CheckDB: N | Rollback: N
 * ============================================================ */
describe('TC171 – addCourseToMajor: thiếu code', () => {
